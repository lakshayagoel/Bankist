...
//displaying the transactions of account
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (value, i) {
    //check if type is withdraw/deposit
    ...
    const html = `<div class="movements__row">
     ...
     <div class="movements__date">${displayDate}</div>
      ...
      <div class="movements__value"> Rs. ${value.toFixed(2)}</div>
      </div>`;
...
//computing usernames for all account holders
...
const calcDisplaySummary = function (acc) {
  ...
  labelSumInterest.textContent = `Rs. ${Math.abs(interest).toFixed(2)}`;
};
...
//Implementing transfer amt feature
